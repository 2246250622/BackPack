...
1. 點擊[這裡](2. ![Latest Release](https://github.com/2246250622/BackPack/releases/latest))下載腳本文件。
2. ![Latest Release](https://github.com/2246250622/BackPack/releases/latest)
3. 打開Tampermonkey的控制面板，點擊"導入"。
4. 在彈出的對話框中，選擇剛才下載的腳本文件。
5. 點擊"安裝"按鈕，Tampermonkey將自動安裝腳本。
